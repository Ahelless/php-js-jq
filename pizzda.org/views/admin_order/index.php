                ...
                <?php foreach ($ordersList as $order): ?>
                    <tr>
                        ...
                        <? if($order['status'] == 6 || $order['status'] == 4) {
                               echo '<i class="fa fa-pencil-square-o" title="Редактирование невозможно"></i>';
                           } else {
                               echo '<a href="/admin/order/update/' . $order['id'] . '" title="Редактировать"><i class="fa fa-pencil-square-o"></i></a>';
                           }
                        ?>
                        </td>
