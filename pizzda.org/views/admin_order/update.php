            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Фамилия клиента</p>
                        <input type="text" name="userSurname" placeholder="" value="<?php echo $order['user_surname']; ?>">
                        ...
                        <select name="status">
                            ...
                            <option value="5" <?php if ($order['status'] == 5) echo ' selected="selected"'; ?>>В заявке на отмену</option>
                            <option value="6" <?php if ($order['status'] == 6) echo ' selected="selected"'; ?>>Отменён</option>
                        </select>
                        <br>
                        <br>
