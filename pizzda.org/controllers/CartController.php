...
class CartController
{
    ...
    public function actionCheckout()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            // Валидация полей
            if (!User::checkMinTwoLetters($userName)) {
            ...
            if ($errors == false) {
                ...
                $result = Order::save($userName, $userSurname, $userPhone, $userComment, $userId, $productsInCart);

                if ($result) {
                    // Если заказ успешно сохранен
                    // Оповещаем администратора о новом заказе по почте                
                    $adminEmail = 'artem.sdobnikov25@gmail.com';
                    $message = '<a href="http://artemsdobnikov.ru/admin/orders">Список заказов</a>';
                    $subject = 'Новый заказ!';
